...
public final class NoShadingSheets {
    ...
    private static final RenderType CUTOUT_BLOCK_SHEET = RenderTypes.entityCutout(MANGLED_LOCATION_BLOCKS);
    private static final RenderType TRANSLUCENT_BLOCK_ITEM_SHEET = RenderTypes.itemEntityTranslucentCull(MANGLED_LOCATION_BLOCKS);

    private static final RenderType TRANSLUCENT_ITEM_SHEET = RenderTypes.itemEntityTranslucentCull(MANGLED_LOCATION_ITEMS);
