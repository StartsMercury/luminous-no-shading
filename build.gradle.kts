...
tasks {
    ...
    withType<ProcessResources> {
        val data = mapOf(
            ...
            "version_minecraft" to "1.21.6-alpha.25.15.craftmine",
        )
...
run {
    val iris = "maven.modrinth:iris:1.8.11+1.21.5-fabric"
    val sodium = "maven.modrinth:sodium:mc1.21.5-0.6.13-fabric"
...
dependencies {
    modCompileOnly(fabricApi.module("fabric-rendering-data-attachment-v1", "0.119.9+1.21.5"))
}
