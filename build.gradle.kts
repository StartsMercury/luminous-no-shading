object Constants {
    ...
    const val VERSION_MINECRAFT = "1.21.2-pre2"
}
...
tasks {
    ...
    withType<ProcessResources> {
        val data = mapOf(
            ...
            "version_minecraft" to "1.21.2-beta.2",
        )
...
dependencies {
    modCompileOnly(fabricApi.module("fabric-rendering-data-attachment-v1", "0.105.3+1.21.2"))
}
